...
//u32 wl_dbg_level = WL_DBG_ERR|WL_DBG_INFO|WL_DBG_DBG;

#define MAC2STR(a) (a)[0], (a)[1], (a)[2], (a)[3], (a)[4], (a)[5]
#define MACSTR "%02x:%02x:%02x:%02x:%02x:%02x"
#define MAX_WAIT_TIME   3000       //1500
#define WL_SCAN_ACTIVE_TIME	 40
#define WL_SCAN_PASSIVE_TIME	130
static s8 ioctlbuf[WLC_IOCTL_MAXLEN];

//ZTE:add by zhangyiming for wifi scan problem
...
#if 0
/* ZTE: add by zhangyiming for create Wifi Group system restart ++ */
	WL_DBG(("Wait for interface deleted completely\n"));
	rtnl_unlock();
	msleep(1000);
	rtnl_lock();
/* ZTE: add by zhangyiming for create Wifi Group system restart -- */
	...
	const u8* buf, size_t len, u64 *cookie)
{
	...
	u32 wpsie_len = 0;
	u32 id;
	u32 retry=0;//add by shenggh on 2012-10-15
	bool ack = false;
	wifi_p2p_pub_act_frame_t *act_frm;
	wifi_p2psd_gas_pub_act_frame_t *sd_act_frm=NULL;//add by shenggh on 2012-10-15
	s8 eabuf[ETHER_ADDR_STR_LEN];
...
static s32 wl_inform_single_bss(struct wl_priv *wl, struct wl_bss_info *bi)
{
	...
	/* ZTE: add by for Wifi scan channel 15 system abort ++ */
