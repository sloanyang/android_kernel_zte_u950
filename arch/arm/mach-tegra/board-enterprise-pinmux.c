...
static __initdata struct tegra_pingroup_config enterprise_pinmux_common[] = {
	...
	DEFAULT_PINMUX(LCD_PWR0,        DISPLAYA,        NORMAL,    NORMAL,     OUTPUT),//zte lipeng10094834 add 20120525
	DEFAULT_PINMUX(LCD_PWR2,        DISPLAYA,        NORMAL,    NORMAL,     INPUT),
	//ZTE: remove for max98095
	...
	DEFAULT_PINMUX(LCD_D0,          DISPLAYA,        PULL_UP,    NORMAL,     OUTPUT),//zte liliguo modified for mhl reset gpio 20121101
	...
	DEFAULT_PINMUX(LCD_D10,         DISPLAYA,        NORMAL,    NORMAL,     INPUT), //zte yaoling for U985 rear cam powerdown control
	...
	DEFAULT_PINMUX(GMI_A16,         UARTD,           PULL_UP,    NORMAL,     OUTPUT),
	DEFAULT_PINMUX(GMI_A17,         UARTD,           PULL_UP,    NORMAL,     INPUT),
	DEFAULT_PINMUX(GMI_A18,         UARTD,           PULL_UP,    NORMAL,     INPUT),
	DEFAULT_PINMUX(GMI_A19,         UARTD,           PULL_UP,    NORMAL,     OUTPUT),
	DEFAULT_PINMUX(CAM_MCLK,        VI_ALT2,         NORMAL,    NORMAL,     INPUT),
	DEFAULT_PINMUX(GPIO_PCC1,       RSVD1,           NORMAL,    NORMAL,     INPUT),
	DEFAULT_PINMUX(GPIO_PBB0,       RSVD1,           NORMAL,    NORMAL,     INPUT),
	DEFAULT_PINMUX(GPIO_PBB3,       VGP3,            NORMAL,    NORMAL,     INPUT),
	DEFAULT_PINMUX(GPIO_PBB6,       VGP6,            NORMAL,    NORMAL,     INPUT), //add by yaoling for torch 0615
	...
	DEFAULT_PINMUX(CLK_32K_OUT,     BLINK,           PULL_DOWN, NORMAL,   OUTPUT),
	...
	/*ALS  interrupt*/
	DEFAULT_PINMUX(GMI_CS1_N,       GMI,             NORMAL,   NORMAL,     INPUT),
...
//	DEFAULT_PINMUX(LCD_D10,         DISPLAYA,        NORMAL,    NORMAL,     OUTPUT), //zte yaoling for U985 rear cam powerdown control
};
...
static __initdata struct tegra_pingroup_config enterprise_unused_pinmux_common[] = {
	...
	//DEFAULT_PINMUX(GPIO_PBB6,      VGP6,             PULL_DOWN,    TRISTATE,  OUTPUT),  //del by yaoling for torch 0615
	...
	#endif
//  DEFAULT_PINMUX(GMI_CS0_N,       GMI,             PULL_DOWN,    TRISTATE,  OUTPUT), /* ZTE: removed by li.liguo for MHL RESET 20120528 ++*/
...
/* ZTE: removed by pengtao for poweron key 20120528 ++*/
...
//	DEFAULT_PINMUX(LCD_D10,         DISPLAYA,        PULL_DOWN,    TRISTATE,  OUTPUT),//zte yaoling for U985 rear cam powerdown control 20120531
//	DEFAULT_PINMUX(LCD_PWR0,        DISPLAYA,        PULL_DOWN,    TRISTATE,  OUTPUT),//zte lipeng10094834 delete 20120525
};
...
static __initdata struct pin_info_low_power_mode enterprise_unused_gpio_pins_common[] = {
	...
	//PIN_GPIO_LPM("GPIO_PBB6",    TEGRA_GPIO_PBB6,  0, 0),  // zte yaoling for cam flash 
	...
	#ifndef  CONFIG_SIRF_GPS
	PIN_GPIO_LPM("GMI_AD11",     TEGRA_GPIO_PH3,  0, 0),
	#endif
//  PIN_GPIO_LPM("GMI_CS0_N",    TEGRA_GPIO_PJ0,  0, 0),  // ZTE: removed by li.liguo for MHL Init key 20120528 --*/
...
//	PIN_GPIO_LPM("GMI_CS7_N",    TEGRA_GPIO_PI6,  0, 0), // ZTE: removed by pengtao for powerkey 20120528
...
static __initdata struct pin_info_low_power_mode enterprise_unused_gpio_pins_a02[] = {
	//PIN_GPIO_LPM("LCD_D10",      TEGRA_GPIO_PF2,  0, 0), //zte yaoling for U985 rear cam powerdown control 20120531
//	PIN_GPIO_LPM("LCD_PWR0",     TEGRA_GPIO_PB2,  0, 0),  //zte lipeng10094834 delete 20120525
};

static __initdata struct tegra_pingroup_config enterprise_max98095_spi_pinmux_common[] = {
	#ifdef CONFIG_PROJECT_V985
...
static __initdata struct tegra_pingroup_config enterprise_max98095_i2c_pinmux_common[] = {
	DEFAULT_PINMUX(LCD_CS0_N,       DISPLAYA,        NORMAL,    NORMAL,     INPUT),
       DEFAULT_PINMUX(LCD_SCK,        DISPLAYA,        PULL_DOWN,    TRISTATE,  OUTPUT),
	DEFAULT_PINMUX(LCD_SDOUT,       DISPLAYA,        PULL_DOWN,    TRISTATE,  OUTPUT),
	DEFAULT_PINMUX(LCD_SDIN,        DISPLAYA,        PULL_DOWN,    TRISTATE,  OUTPUT),
...
static __initdata struct pin_info_low_power_mode enterprise_unused_max98095_i2c_gpio_pins_common[] = {
	PIN_GPIO_LPM("LCD_SCK",      TEGRA_GPIO_PZ4,  0, 0),
	PIN_GPIO_LPM("LCD_SDOUT",    TEGRA_GPIO_PN5,  0, 0),
	PIN_GPIO_LPM("LCD_SDIN",     TEGRA_GPIO_PZ2,  0, 0),
};
...
#ifdef CONFIG_PROJECT_V985
       //ZTE: V985 use spi1 bus
       tegra_pinmux_config_table(enterprise_max98095_i2c_pinmux_common,
			ARRAY_SIZE(enterprise_max98095_i2c_pinmux_common));  
       enterprise_set_unused_pin_gpio(enterprise_unused_max98095_i2c_gpio_pins_common,
		       ARRAY_SIZE(enterprise_unused_max98095_i2c_gpio_pins_common));
       tegra_pinmux_config_table(enterprise_max98095_spi_pinmux_common,
				  ARRAY_SIZE(enterprise_max98095_spi_pinmux_common));  
#else
	//ZTE: IIC driver for Max98095
