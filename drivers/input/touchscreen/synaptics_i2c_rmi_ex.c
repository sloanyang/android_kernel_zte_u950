...
#define TOUCH_POWER_1V8_EN    TEGRA_GPIO_PB2
...
static ssize_t synaptics_vkeys_show(struct kobject *kobj, struct kobj_attribute *attr,char *buf)
{
    ...
    /*ZTE: modified by tong.weili for  扩大软按键响应区域20120510 ++*/
	return sprintf(buf,
	#if 0
	__stringify(EV_KEY) ":" __stringify(KEY_MENU) ":71:1020:79:70" 
	":" __stringify(EV_KEY) ":" __stringify(/*KEY_HOME*/KEY_HOMEPAGE) ":204:1020:79:70"/*ZTE: modified by tong.weili 解决4.0 HOME键功能无法回到主菜单20111221*/
	":" __stringify(EV_KEY) ":" __stringify(KEY_BACK) ":330:1020:79:70"
	":" __stringify(EV_KEY) ":" __stringify(KEY_SEARCH) ":470:1020:79:70"	
        #else
        __stringify(EV_KEY) ":" __stringify(KEY_MENU) ":65:1050:110:110" 
	":" __stringify(EV_KEY) ":" __stringify(KEY_HOMEPAGE) ":198:1050:110:110"
	":" __stringify(EV_KEY) ":" __stringify(KEY_BACK) ":336:1050:110:110"
	":" __stringify(EV_KEY) ":" __stringify(KEY_SEARCH) ":475:1050:110:110"	
	#endif
	"\n");
    /*ZTE: modified by tong.weili for  扩大软按键响应区域20120510 --*/
}
...
/*ZTE: modified by tong.weili to delete build warning 20120424 --*/ 
	...
	printk(KERN_ERR "probing for Synaptics RMI4 device %s at $%02X...\n", client->name, client->addr);
        ...
        /*ZTE: added by tong.weili 解决开机偶发触摸失效20120606 ++*/
	...
	ts->input_dev->phys = client->name;
      ...
      {
          ts->f11_max_x = s_F11_Max_X;
          ts->f11_max_y = s_F11_Max_Y;
      }
      else
      {
...
static int synaptics_rmi4_remove(struct i2c_client *client)
{
	...
	input_unregister_device(ts->input_dev);
      ...
      /*ZTE: modified by tong.weili for U970 Touch Power enable 20111116 ++*/
      gpio_free(TOUCH_POWER_2V8_EN);
      gpio_free(TOUCH_POWER_1V8_EN);
      if(ventana_LDO3)
      {
          regulator_put(ventana_LDO3);
          ventana_LDO3 = NULL;
      }      
      /*ZTE: modified by tong.weili for U970 Touch Power enable 20111116 --*/
