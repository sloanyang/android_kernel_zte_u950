...
static int tps80031_temp_table[] = {
	...
	#endif
    755,750,/*-2,-1*/
    746,741,737,732,727,722,717,711,706,700,/*0,9*/
    694,688,682,675,669,662,655,648,641,633,/*10,19*/
    627,619,611,604,596,588,580,572,564,555,/*20,29*/
    547,539,530,522,513,504,496,487,479,470,/*30,39*/
    461,453,444,436,427,418,410,401,393,385,/*40,49*/
    377,369,361,353,345,337,329,322,314,307,/*50,59*/
    300,293,286,/*60,62*/
};
...
/*ZTE:add by caixiaoguang 20120906 for get battery ++*/
int tps80031_get_battery_temp(void)
{
    int adc_code, temp,battery_temp;
	...
	battery_temp = (temp - 2) * 10; /* in tenths of degree Celsius */
    //printk("[%s]CXG get temp=%d,battery_temp=%d\n",__func__,temp,battery_temp);
	return  battery_temp;
}
/*ZTE:add by caixiaoguang 20120906 for get battery --*/
