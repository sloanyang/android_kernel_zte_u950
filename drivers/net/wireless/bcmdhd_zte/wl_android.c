...
void ventana_sdio_normal_config (void);
void ventana_sdio_tristate_config (void);
#endif
...
int wl_android_post_init(void)
{
	...
	if (!dhd_download_fw_on_driverload) {
		...
		printk("enter wl_android_post_init\n");
		dhd_customer_gpio_wlan_ctrl(WLAN_RESET_OFF);
	#ifdef CONFIG_MACH_VENTANA
		ventana_sdio_tristate_config();
	#endif
