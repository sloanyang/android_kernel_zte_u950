...
//	REGULATOR_SUPPLY("avdd_dsi_csi", NULL), //zte lipeng10094834 delete 20120525
...
static struct regulator_consumer_supply tps80031_ldo4_supply_a02[] = {
	REGULATOR_SUPPLY("avdd_lcd", NULL),
     	REGULATOR_SUPPLY("avdd_dsi_csi", NULL),   //zte lipeng10094834 add 20120525
};
...
static struct regulator_consumer_supply tps80031_ldo7_supply_a02[] = {
	...
	REGULATOR_SUPPLY("avdd_lcd", NULL),  //zte lipeng10094834 add 20120525
};
...
TPS_PDATA_INIT(ldo3, common, 1000, 3300, tps80031_rails(VIO), 0, 0, 3300, 3300, 0, 1, 1, PWR_OFF_ON_SLEEP, 0);
...
TPS_PDATA_INIT(ldo5, common, 1000, 3300, 0, 1, 0, 1, 3000, 1, 1, 0, 0, 0);
...
TPS_PDATA_INIT(ldo7, a02, 1000, 3300, tps80031_rails(VIO), 1, 1, 3000, 3000, 1, 1, 1, PWR_REQ_INPUT_PREQ1, 0); //zte lipeng10094834 modify 20120525
...
static struct tps80031_charger_platform_data bcharger_pdata = {
	.max_charge_volt_mV = 4350,/*ZTE:modeyied by caixiaoguang 20120531 for charge++*/ 
...
static struct gpio gpio_reg_sdmmc3_vdd_sel_gpios[] = {
	{
		//.gpio =, //TEGRA_GPIO_PM1,  //zte yaoling for rear cam powerdown control 20120531
		.flags = 0,
...
//FIXED_REG(7, vdd_sdmmc3_2v85_en,  NULL,
	//	TEGRA_GPIO_PF2, true, 2850, 0, 0); //zte yaoling for rear cam powerdown control 20120531
//FIXED_REG(8, lcd_1v8_en,  NULL,
//		TEGRA_GPIO_PB2, true, 1800, 0, 0); //zte lipeng10094834 delete 20120525
...
static struct platform_device *fixed_regs_devices_a03[] = {
	FIXED_REGS_COMMON,
	//ADD_FIXED_REG(vdd_sdmmc3_2v85_en), //zte yaoling for rear cam powerdown control 20120531
//	ADD_FIXED_REG(lcd_1v8_en),  //zte lipeng10094834 delete 20120525
};
