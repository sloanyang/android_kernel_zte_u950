...
static const struct tegra_emc_table enterprise_emc_tables_samsung_U950[] = {
	{
		0x32,       /* Rev 3.2 */
...
static const struct tegra_emc_table enterprise_emc_tables_hynix_U950[] = {
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
	...
	},
	{
		...
		380000,     /* SDRAM frequency */
		{
			...
			0x00000089, /* EMC_ZCAL_WAIT_CNT */
			0x000c000c, /* EMC_MRS_WAIT_CNT */
				0xa0f10303, /* EMC_AUTO_CAL_CONFIG */
			0x00000000, /* EMC_CTT */
			0x00000000, /* EMC_CTT_DURATION */
			0x80000c4d, /* EMC_DYN_SELF_REF_CONTROL */
			0x0000000b, /* MC_EMEM_ARB_CFG */
...
static const struct tegra_emc_table enterprise_emc_tables_samsung_U985[] = {
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
...
static const struct tegra_emc_table enterprise_emc_tables_hynix_U985[] = {
		{
			0x32,		/* Rev 3.2 */
			25500,		/* SDRAM frequency */
			{
...
static const struct tegra_emc_table enterprise_emc_tables_samsung_V985[] = {
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
	...
	},
	{
		...
		380000,     /* SDRAM frequency */
		{
			...
			0x001f0084, /* EMC_CFG_DIG_DLL */
			0x00008000, /* EMC_CFG_DIG_DLL_PERIOD */
			0x0005c000, /* EMC_DLL_XFORM_DQS0 */
			0x0005c000, /* EMC_DLL_XFORM_DQS1 */
			0x0005c000, /* EMC_DLL_XFORM_DQS2 */
			0x0005c000, /* EMC_DLL_XFORM_DQS3 */
			0x0005c000, /* EMC_DLL_XFORM_DQS4 */
			0x0005c000, /* EMC_DLL_XFORM_DQS5 */
			0x0005c000, /* EMC_DLL_XFORM_DQS6 */
			0x0005c000, /* EMC_DLL_XFORM_DQS7 */
			0x00000000, /* EMC_DLL_XFORM_QUSE0 */
			0x00000000, /* EMC_DLL_XFORM_QUSE1 */
			0x00000000, /* EMC_DLL_XFORM_QUSE2 */
			0x00000000, /* EMC_DLL_XFORM_QUSE3 */
...
static const struct tegra_emc_table enterprise_emc_tables_hynix_V985[] = {  //same with samsung_V985 for test--gucz
		{
			0x32,		/* Rev 3.2 */
			25500,		/* SDRAM frequency */
			{
...
static const struct tegra_emc_chip enterprise_emc_chips[] = {
	{
		.description = "Samsung 533MHz",
		.mem_manufacturer_id = 0x01,
		.mem_revision_id1 = -1,
		.mem_revision_id2 = -1,
		.mem_pid = -1,
	},
	{
		.description = "Hynix 533MHz",
		.mem_manufacturer_id = 0x06,
		.mem_revision_id1 = -1,
		.mem_revision_id2 = -1,
		.mem_pid = -1,
	},	
...
/* ZTE: remove by dongjinguang for new dvfs table on 20120703 ++ */    
    #if 0
    ...
    #endif
    /*modified by gucz 20120917 +++*/
	int maker_id = 0;
	maker_id = zte_tegra_emc_get_dram_id(); 
	if( enterprise_emc_chips[0].mem_manufacturer_id == maker_id)
	{
    #if  defined(CONFIG_DVFS_TABLE_U950)
    tegra_init_emc(enterprise_emc_tables_samsung_U950, ARRAY_SIZE(enterprise_emc_tables_samsung_U950));
    #elif defined(CONFIG_DVFS_TABLE_V985)
    tegra_init_emc(enterprise_emc_tables_samsung_V985, ARRAY_SIZE(enterprise_emc_tables_samsung_V985));
    #elif defined(CONFIG_DVFS_TABLE_U985)
    tegra_init_emc(enterprise_emc_tables_samsung_U985, ARRAY_SIZE(enterprise_emc_tables_samsung_U985));
    #endif
	}
	else if( enterprise_emc_chips[1].mem_manufacturer_id == maker_id)
	{
    #if  defined(CONFIG_DVFS_TABLE_U950)
		tegra_init_emc(enterprise_emc_tables_hynix_U950, ARRAY_SIZE(enterprise_emc_tables_hynix_U950));
    #elif defined(CONFIG_DVFS_TABLE_V985)
		tegra_init_emc(enterprise_emc_tables_hynix_V985, ARRAY_SIZE(enterprise_emc_tables_hynix_V985));
	#elif defined(CONFIG_DVFS_TABLE_U985)
		tegra_init_emc(enterprise_emc_tables_hynix_U985, ARRAY_SIZE(enterprise_emc_tables_hynix_U985));
    #endif
	}
   /*modified by gucz 20120917 ---*/
