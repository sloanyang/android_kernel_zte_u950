...
#define modem_power_enb	TEGRA_GPIO_PM6
#define modem_usb3v3_enb	TEGRA_GPIO_PP1
#define usb_port_ctrl	TEGRA_GPIO_PM7
/*modem_power_key  modem_download_en modem_reset_en not used uart_port_switch not found*/
#define modem_power_key   TEGRA_GPIO_PD0
#define modem_download_en TEGRA_GPIO_PI4
#define modem_reset_en    TEGRA_GPIO_PD1

#define modem_dead        TEGRA_GPIO_PP2
#define uart_port_switch	TEGRA_GPIO_PV0
...
#define AP_MHL_INT		TEGRA_GPIO_PJ0
#define AP_MHL_RESET	TEGRA_GPIO_PE0
#endif
#include <mach/gpio.h>
#include <mach/irqs.h>
...
int zteenterprise_keys_init(void); // ZTE: added by pengtao for gpio-key

#ifdef CONFIG_SND_SOC_MAX98095
#define  CODEC_CEN_PIN TEGRA_GPIO_PX0
