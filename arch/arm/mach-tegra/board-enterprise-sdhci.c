...
#define ENTERPRISE_SD_CD TEGRA_GPIO_PJ0
#else
#define ENTERPRISE_SD_CD TEGRA_GPIO_PU5
#endif
...
#define CD_GPIO_POLARITY (CONFIG_MMC_PRESENT_PINLEVEL)
static unsigned int sd_status(struct device *dev){
	int card_present;
	unsigned int pin_stat;

	pin_stat = gpio_get_value(ENTERPRISE_SD_CD);
	card_present = (pin_stat == CD_GPIO_POLARITY)? 1 : 0;

	return card_present;
}

static struct tegra_sdhci_platform_data tegra_sdhci_platform_data2 = {
	.cd_gpio = ENTERPRISE_SD_CD,
	.cd_polarity = CD_GPIO_POLARITY,
	.wp_gpio = -1,
	.power_gpio = -1,
	.async_suspend = 1,
	.tap_delay = 0x0F,
